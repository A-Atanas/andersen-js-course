...
console.log(
  'Array Practice 6, transformArrayToNumber([10, 20, 30], (acc, item) => acc + item) —>',
  transformArrayToNumber([10, 20, 30], (acc, item) => acc + item)
); // 60

console.log(
  'Array Practice 6, transformArrayToNumber([10, 20, 30], (acc, item) => acc + item, 10) —>',
...
console.log(
  'Array Practice 6, transformArrayToNumber([10, 20, 30], (acc, item) => acc * item, 1) —>',
...
console.log('Array Practice 7, take([1, 2, 3], 5) —>', take([1, 2, 3], 5)); // [1, 2, 3]

console.log('Array Practice 7, take([1, 2, 3], 2) —>', take([1, 2, 3], 2)); // [1, 2]
